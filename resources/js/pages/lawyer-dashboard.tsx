    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="mb-4">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Lawyer Dashboard</h1>
                    <p className="text-gray-600 dark:text-gray-400">Manage your cases and client interactions</p>
                </div>
                ...
                <div className="grid auto-rows-min gap-4 md:grid-cols-4">
                    ...
                    <div className="rounded-xl border border-sidebar-border/70 bg-white p-4 dark:border-sidebar-border dark:bg-gray-900">
                        <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400">My Clients</h3>
                        <p className="mt-2 text-2xl font-bold text-gray-900 dark:text-white">0</p>
                    </div>
                    <div className="rounded-xl border border-sidebar-border/70 bg-white p-4 dark:border-sidebar-border dark:bg-gray-900">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    <div className="relative min-h-[300px] flex-1 overflow-hidden rounded-xl border border-sidebar-border/70 p-4 dark:border-sidebar-border">
                        <h3 className="font-semibold text-gray-900 dark:text-white">Current Cases</h3>
